...
public class MaxRainWaterTrapHistogram {
    ...
    public static void main(String[] args) {
        int arr[] = {10, 1, 6, 2, 1, 0, 1, 3, 2, 1, 2, 1};
        int N = arr.length;
...
//        int res=0;
//        sum  = (sum- height[point1]);
//        sum = (sum- height[point2]);
//
//        while(point1<point2){
//            int min=Math.min(height[point1],height[point2]);
//            int width=point2-point1-1;
//            System.out.println("res, (min*width)-sum, "+ res +" "+((min*width)-sum));
//            res=Math.max(res,((min*width)-sum));
//            if(height[point1]<height[point2]){
//                point1++;
//                sum = sum- height[point1];
//                System.out.println("res, sum, point1 "+ res +" "+sum+ " "+point1);
//            }
//            else{
//                point2--;
//                sum = sum- height[point2];
//                System.out.println("res, sum, point1 "+ res +" "+sum+ " "+point2);
//            }
//        }
//        return res;
//    }
